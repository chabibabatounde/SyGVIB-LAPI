...
imgListDir = '/home/rodolpho/Bureau/LAPI-RO2/training_data/train20X20/'
...
for each in letters:
    ...
    for aTraining in range(lettersDict[each]):
        ...
        #imsave('/home/rodolpho/Bureau/LAPI-RO2/training_data/train20X20/'+each+'_'+str(aTraining)+'.jpg', letterDetails)
...
joblib.dump(model, '/home/rodolpho/Bureau/LAPI-RO2/ml_models/SVC_model/SVC_model.pkl')
testDir = '/home/rodolpho/Bureau/LAPI-RO2/test_images/learn/learn1.jpg'
testImgDet = readandpreprocess(testDir)
#testImgDet=np.reshape(testImgDet,-1)
print(testImgDet.shape)
print(model.predict(testImgDet))



joblib.dump(model, '/home/rodolpho/Bureau/LAPI-RO2/ml_models/SVC_model/SVC_model.pkl')
testDir = '/home/rodolpho/Bureau/LAPI-RO2/test_images/learn/learn2.jpg'
testImgDet = readandpreprocess(testDir)
#testImgDet=np.reshape(testImgDet,-1)
print(testImgDet.shape)
print(model.predict(testImgDet))
...
joblib.dump(model, '/home/rodolpho/Bureau/LAPI-RO2/ml_models/SVC_model/SVC_model.pkl')
testDir = '/home/rodolpho/Bureau/LAPI-RO2/test_images/learn/learn3.jpg'
testImgDet = readandpreprocess(testDir)
#testImgDet=np.reshape(testImgDet,-1)
print(testImgDet.shape)
print(model.predict(testImgDet))
...
joblib.dump(model, '/home/rodolpho/Bureau/LAPI-RO2/ml_models/SVC_model/SVC_model.pkl')
testDir = '/home/rodolpho/Bureau/LAPI-RO2/test_images/learn/learn4.jpg'
testImgDet = readandpreprocess(testDir)
#testImgDet=np.reshape(testImgDet,-1)
print(testImgDet.shape)
print(model.predict(testImgDet))
...
joblib.dump(model, '/home/rodolpho/Bureau/LAPI-RO2/ml_models/SVC_model/SVC_model.pkl')
testDir = '/home/rodolpho/Bureau/LAPI-RO2/test_images/learn/learn5.jpg'
testImgDet = readandpreprocess(testDir)
#testImgDet=np.reshape(testImgDet,-1)
print(testImgDet.shape)
print(model.predict(testImgDet))
...
joblib.dump(model, '/home/rodolpho/Bureau/LAPI-RO2/ml_models/SVC_model/SVC_model.pkl')
testDir = '/home/rodolpho/Bureau/LAPI-RO2/test_images/learn/learn6.jpg'
testImgDet = readandpreprocess(testDir)
#testImgDet=np.reshape(testImgDet,-1)
print(testImgDet.shape)
print(model.predict(testImgDet))
